...
We use the estimated number of atoms for a pure Ar expansion as the lower limit for the actual cluster size, start our search for model structures from there.
%
%Additionally,
...
\begin{figure}[ht]
 ...
 \caption{Cluster structures composed of 13 argon atoms and two additional xenon
          ...
          (a) closest possible, (b) middle, (c) furthest away.}
