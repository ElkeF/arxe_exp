...
At the particular photon energy selected here, atop of this band a sharp
feature is also visible (in Figure \ref{figure:oval1} at a kinetic energy of
about 1.8 eV). {\color{red}{Das Maximum ist bei etwa 1.8. Meinst du nicht oberhalb
von 1.8?}}
For larger clusters (above $\langle N\rangle \approx 100$),
it shows a dispersion {\color{red}{Was genau meinst du mit dispersion?}}
characteristic for photoemission of crystalline bulk matter.\cite{foerstel_arg1_2010,foerstel_arg2_2011} 

Ar 3p spectra of the mixed clusters show neither of these traits.
Rather, the Ar band is symmetric,
less wide than in the pure clusters and at a higher binding energy.
{\color{red}{Wenn du dich auf panel b beziehst, dann kann das zwar sein, man sieht
es aber aus der Abbildung nicht. Kannst du das noch genauer belegen?}}
