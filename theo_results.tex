...
Mixed cluster structures were optimized using force fields to
...
The three energetically separated peaks in the ETMD(3) spectrum pertain to different combinations of the Xe 5p$_j^{-1}$ vacancy states, which have a substantial fine-structure splitting (see Section `Experimental Results'). 
%\ref{sec:exp_results}).
%
