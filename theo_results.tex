...
\toprule
name                 & Xe atoms & Ar atoms & Xe$_{\rm cl}$ \% & ICD   &  ETMD & \% ICD\\ %$\Gamma_{\rm ICD,ETMD}$\\
\midrule
...
\midrule
Ar$_{36}$Xe$_{2}$    &      2   &     36   &  5.3  & 0.117 & 0.151 &  43.6\\
Ar$_{34}$Xe$_{4}$    &      4   &     34   & 10.5  & 0.248 & 0.587 &  29.7\\
Ar$_{33}$Xe$_{5}$    &      5   &     33   & 13.2  & 0.335 & 0.844 &  28.4\\
Ar$_{25}$Xe$_{13}$   &     13   &     25   & 34.2  & 0.828 & 5.414 &  13.3\\
Ar$_{14}$Xe$_{24}$   &     24   &     14   & 63.2  & 1.488 &16.718 &   8.2\\
Ar$_{13}$Xe$_{25}$   &     25   &     13   & 65.8  & 1.432 & 4.995 &  22.3\\
Ar$_{3}$Xe$_{35}$    &     35   &      3   & 92.1  & 2.017 & 7.051 &  22.2\\
\bottomrule
\end{tabular}
...
\begin{figure}[ht]
 ...
 \caption{Simulated electron emission spectra of an Ar 3s vacancy in 
          ...
          the ICD spectrum.
          {\it Q: Ich sehe die traces für die 'furthest' Konfiguration nicht(?!) Q: Warum ist in diesen (und vielen anderen) Bildern jedes Label doppelt?}}
 \label{figure:2tops}
\end{figure}
%
