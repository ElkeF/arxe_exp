...
\draw [diplom1] (7.4,axis cs:\pgfkeysvalueof{/pgfplots/ymin}) --
                (7.4,axis cs:\pgfkeysvalueof{/pgfplots/ymax});

%\draw [diplom2] (, axis cs:\pgfkeysvalueof{/pgfplots/ymin}) --
%                (, axis cs:\pgfkeysvalueof{/pgfplots/ymax});
