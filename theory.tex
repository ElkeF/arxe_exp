...
\end{equation}
%
depending on constants ($a_{m,k}=4,2$) {\it Q: ??? Hei\ss t das, $a_{m.k}$ kann die Werte 2 und 4 annehmen?}
...
This choice is identical to the one made in Reference \citenum{Fasshauer13}.
